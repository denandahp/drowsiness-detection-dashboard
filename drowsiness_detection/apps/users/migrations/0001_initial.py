...
import drowsiness_detection.apps.users.model
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(choices=[(1, 'Superuser'), (2, 'Admin'), (3, 'Staff')])),
            ],
        ),
        migrations.CreateModel(
            name='User',
            ...
            managers=[
                ('objects', drowsiness_detection.apps.users.model.CustomUserManager()),
            ],
        ),
    ]
